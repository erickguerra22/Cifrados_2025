# DESCIFRADO AFIN POR FUERZA BRUTA

from tabulate import tabulate
from Parte_A.frequencies import theorical, getFrequencies
from Parte_A.afin import deCypher
from Parte_A.utils import getOption
import math

alphabet = "abcdefghijklmnñopqrstuvwxyz"
print("-"*40)
print("DESCIFRADO AFIN POR FUERZA BRUTA")
print("-"*40)

cypher = ""
decyph = ""

with open("cyphers/afines.txt", "r", encoding="utf-8") as file:
    cyph = file.read()
...
while not found:
    ...
    for item in maxExperimentals:
        ...
        if op == 2:
            ...
            with open("messages/afin_key.txt", "w", encoding="utf-8") as file:
                file.write(f"A: {a} | B: {b}\n")
                file.write(f"Mensaje descifrado:\n{deCypher(cyph, a, b)}")
                
            print("\n🔑 Clave y mensaje guardados en afin_key.txt\n")
            found = True
            break
